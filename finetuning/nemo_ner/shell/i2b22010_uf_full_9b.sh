...
#SBATCH --output=./2021gatortron/nemo_downstream/nemo_ner/log/9b_i2b22010_%j.out
...
expr_tag=9B_2010i2b2

NEMO_GS=./2021gatortron/data/ner/nemo_ner_2010i2b2_full_new
...
CONF=./2021gatortron/nemo_downstream/nemo_ner/shell/i2b22010_uf_full_9b.yaml
