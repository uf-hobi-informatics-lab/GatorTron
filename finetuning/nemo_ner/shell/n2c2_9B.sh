...
#SBATCH --output=./2021gatortron/nemo_downstream/nemo_ner/log/9b_n2c2_%j.out
...
NEMO_GS=./2021gatortron/data/ner/nemo_ner_2018n2c2_final/
...
CONF=./2021gatortron/nemo_downstream/nemo_ner/shell/n2c2_9B.yaml
